...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2021 a las 00:30:43
...
ALTER TABLE `tbl_sucursales`
  ...
  ADD CONSTRAINT `FK_SUCURSALES_PAIS` FOREIGN KEY (`ID_PAIS`) REFERENCES `tbl_sucursales_pais` (`ID_PAIS`) ON DELETE CASCADE ON UPDATE CASCADE;
